...
def listar():
    ...
    if len(produtos) > 0:
        ...
        print(f'Não exite produto cadastrado')
...
def inserir():
    ...
    if cursor.rowcount == 1:
        print(f'O produto {nome} foi inserida com sucesso')
    else:
        print(f'Não foi possivel inserir o produto.')
    desconectar(conn)
...
def atualizar():
    ...
    if cursor.rowcount == 1:
        ...
        print(f'Erroa o atualizar o produto')
    desconectar(conn)
